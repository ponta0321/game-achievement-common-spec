...
| Layer | 仕様 | 必須度 | 役割 |
|---|---|---|---|
| **Data** | 本ファイル + 3 つの JSON Schema | 必須 | データ構造の定義 (Basic 適合) |
| **Transport** | [transport.md](transport.md) | 任意 | OAuth 2 サーバー間直接通信 (Connected 適合) |
| **Trust** | [trust.md](trust.md) | 任意 | JWT 署名による真正性証明 (Verified 適合) |
